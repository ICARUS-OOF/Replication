...
Game::Game(bool debugModeEnabled) :
	...
	gameData(new GameData(screenPtr, GAMESTATEVALUE::WORLDSTATE, new PlayerStats(20, 0, 0, 7), screenPtr->GetScreenSize(), screenPtr->GetConsoleViewportSize(), debugModeEnabled)),
